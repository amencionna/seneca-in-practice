...
exercise.addSetup(function(mode, callback) {
  ...
  this.solutionArgs = [this.solution, mode]
  this.submissionArgs = [submissionFilePath, mode]
  this.solution = path.join(__dirname, '/seneca-decorate-executor.js')
  this.submission = path.join(__dirname, '/seneca-decorate-executor.js')
  callback()
})
